// The algorithm follows the directions in the order the if statements are written.
// In this case, it tries Down → Up → Right → Left, so if multiple paths exist, it 
// always chooses the first valid one found in that order and stops once the 
